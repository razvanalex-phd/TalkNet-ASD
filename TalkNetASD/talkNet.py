...
from TalkNetASD.loss import lossA, lossAV, lossV
from TalkNetASD.model.talkNetModel import talkNetModel
...
class talkNet(nn.Module):
    ...
    def train_network(self, loader, epoch, **kwargs):
        ...
        for num, (audioFeature, visualFeature, labels) in enumerate(
            loader, start=1
        ):
            self.zero_grad()
    ...
    def evaluate_network(self, loader, evalCsvSave, evalOrig, **kwargs):
        ...
        cmd = (
            "python -O utils/get_ava_active_speaker_performance.py -g %s -p %s "
